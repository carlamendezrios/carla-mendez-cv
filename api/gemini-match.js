export default async function handler(req, res) {
  ...
  const SHEETS_WEBHOOK = 'https://script.google.com/macros/s/AKfycbxp1uRb1hU-29C077Zg2mvgE1ag3xkbCs69hKzcxYcOpCcfqi9gYE8qEkT2od4NRBg/exec';
...
- I+D+i / CALIDAD: Enfócate en conectar el laboratorio con la viabilidad comercial y el escalado industrial.`;
  ...
  try {
    ...
    // Guardar en Google Sheets (sin esperar para no ralentizar)
